...
แอปจัดชีวิตส่วนตัว: งาน/การบ้าน, ตารางเรียน, นิสัย และเงิน — ออกแบบให้ใช้บน iPad และมือถือ Android เป็นหลัก หน้าแอปเป็นภาษาอังกฤษ
...
2. ในแอป: Settings → Sync → ใส่ token และตั้ง sync passphrase (อย่างน้อย 8 ตัว)
3. ทำแบบเดียวกันบนอีกเครื่อง ใช้ **passphrase เดียวกัน** (token จะใช้อันเดียวกันหรือคนละอันก็ได้)
...
ในแอปนี้: Settings → Data → Import → เลือกไฟล์ (งานที่ล็อก PIN ให้ใส่ PIN เดิมเพื่อย้ายมาด้วย)
